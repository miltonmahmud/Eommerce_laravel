        ...
        <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
          <div class="product-image">
                <div class="product_img_box">
                    <img id="product_img" src="assets/images/product_zoom_img1.jpg" data-zoom-image="assets/images/product_zoom_img1.jpg" alt="{{ $product->name}}" />
                </div>
        ...
        <div class="col-lg-6 col-md-6">
            <div class="pr_detail">
                <div class="product_description">
                    <h4 class="product_title"><a href="#">{{$m_product->name}}</a></h4>
