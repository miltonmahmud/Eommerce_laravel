...
class AdminEditProductComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.admin-edit-product-component', ['categories'=>$categories, 'scategories'=>$scategories,'pattributes'=>$pattributes])->layout('layouts.admin.base');
    }
}
