            ...
            <div class="col-lg-9">
                      <div class="card">
                          <div class="card-header align-middle">
                             ...
                             <a href="{{route('admin.homepageBannerSecond')}}" type="button" class="btn btn-primary float-end">All Banner</a>
                          </div>
                          <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label>Text</label>
                                     <input type="text" placeholder="Text" class="form-control input-md" wire:model="text" />
                            </div>
