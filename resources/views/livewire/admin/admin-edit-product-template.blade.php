                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="updateProduct">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-4" wire:ignore>
                                    <textarea class="form-control" name="" id="short_description" cols="20" rows="5" placeholder="Short Description" wire:model="short_description"></textarea>
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-md-4">
                                      <input type="file" class="input-file input-md" wire:model="newimages" multiple />
                                      @if($newimages)
